...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Dyson",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC5Dyson20DatastoreCoordinator") SWIFT_AVAILABILITY(ios,introduced=10.0)
@interface DatastoreCoordinator : NSObject
...
@property (nonatomic, copy) NSString * _Nullable enrollmentKey;
...
SWIFT_CLASS("_TtC5Dyson15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(Dyson)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Dyson)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Dyson)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Dyson)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Dyson)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC5Dyson12TaskDelegate")
